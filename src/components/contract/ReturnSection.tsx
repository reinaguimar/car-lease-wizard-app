  ...
  return (
    <>
      ...
      <div className="contract-clause">
        <span className="text-sm">11.1 The Renter hereby agrees to return the above-described vehicle to the pick up location no later than the return time specified in Clause 5.1.</span> <span className="translation text-sm">O Locatário concorda em devolver o veículo descrito acima ao local de retirada até, no máximo, o horário de retorno informado na Cláusula 5.1.</span><br />
